...
phone = sys.argv[3]
email = sys.argv[4]
feedback_content = sys.argv[5]
user_ip = sys.argv[6]
user_agent_str = sys.argv[7]
...
<table border="1" cellpadding="6" cellspacing="0" style="border-collapse: collapse;">
    ...
    <tr><th>学号</th><td>{student_id}</td></tr>
    <tr><th>手机号</th><td>{phone if phone else '（未填写）'}</td></tr>
    <tr><th>电子邮箱</th><td>{email if email else '（未填写）'}</td></tr>
    <tr><th>IP 地址</th><td>{user_ip}</td></tr>
    <tr><th>设备信息</th><td>{friendly_user_agent}</td></tr>
    <tr><th>问题描述</th><td>{feedback_content}</td></tr>
</table>
</body>
</html>
"""
